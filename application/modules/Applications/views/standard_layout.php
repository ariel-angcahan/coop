...
<body class="theme-blue">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="widgets_table" class="card">
                ...
                <div class="body">
                    <div class="row">
                        <div class="col-md-12">
                            <table id="registered_list" class="table table-bordered table-striped table-hover dataTable">
                                <thead>
                                    <tr>
                                        <th>REFERENCE</th>
                                        <th>NAME</th>
    ...
    <?PHP 
        $this->load->view('preview_modal');
        $this->load->view('Utilities/javascripts');
    ?>

    <script src="<?php echo base_url('assets/js/dist/application.js'); ?>"></script>
