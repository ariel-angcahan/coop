$(function () {
    ...
    //height
    $demoMaskedInput.find('#height').inputmask("99''99'", { placeholder: "__''__'"});
    //Time
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('9999-999-9999', { placeholder: '____-___-___' });
    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('999-9999', { placeholder: '___-____' });
